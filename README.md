...
<ul>
<li><a href="https://github.com/mdzakirhussain/RTLDesignusingVerilogwithSKY130Technology/blob/main/README.md#introduction-to-optimizations">Introduction to optimizations</a></li>
<li><a href="https://github.com/mdzakirhussain/RTLDesignusingVerilogwithSKY130Technology/blob/main/README.md#combinational-logic-optimizations">Combinational logic optimizations</a></li>
<li><a href="https://github.com/mdzakirhussain/RTLDesignusingVerilogwithSKY130Technology/blob/main/README.md#sequential-logic-optimizations">Sequential logic optimizations</a></li>
...
<b><li>abc -liberty sky130_fd_sc_hd__tt_025C_1v80.lib</li></b><br />
  ...
  <b>Fig.8 After standard cell netlist</b>
...
<p align="justify">  Combinational logic optimization may use techniques such as<br /><ol><li>Constant propagation</li><li>Boolean logic optimization</li></ol>
</p>

<h3><li>Sequential logic optimizations</li></h3>
<p align="justify">Sequential logic optimization can be divided into two
<ol>
  <li>Basic</li>
  <ul>
...
<img src="day3 simulation/dff const1 simulation/2 exec aout.png">
<b>Fig.2 Execute a.out file</b>

<img src="day3 simulation/dff const1 simulation/3 after exec of aout vcd file generated.png">
<b>Fig.3 VCD file generated</b>

<img src="day3 simulation/dff const1 simulation/4 gtkwave command.png">
...
<br /><ul><li><b>DFF CONST2 Simulation results</b></li></ul>
...
<br /><ul><li><b>DFF CONST3 Simulation results</b></li></ul>
 
<img src="day3 simulation/dff const3 simulation/1 iverilog.png">
<b>Fig.1 Invoke iverilog</b>

<img src="day3 simulation/dff const3 simulation/2 a out.png">
<b>Fig.2 Execute a.out file</b>

<img src="day3 simulation/dff const3 simulation/3 vcd file generated.png">
<b>Fig.3 VCD file generated</b>

<img src="day3 simulation/dff const3 simulation/4 gtkwave command.png">
<b>Fig.4 Invoking of gtkwave command</b>
...
<h4>The following are the images of synthesis results of various coding styles of combinational logic done in the lab<h4/>
  ...
  <ul><li><b>opt_check is a design example synthesis results</b></li></ul>
...
<h4>The following are the images of synthesis results of various coding styles of sequential logic done in the lab<h4/>  

 <ul><li><b>DFF CONST1 is a design example synthesis results</b></li></ul>
...
<img src="day3 synthesis/sequential/dff const1/6 after synth.png">
<b>Fig.4 After synthesis</b>
  
  <img src="day3 synthesis/sequential/dff const1/7 dfflib command.png">
<b>Fig.5 dfflibmap command</b>
  
  <img src="day3 synthesis/sequential/dff const1/8 after dfflib.png">
<b>Fig.6 After dfflibmap command</b>
  
  <img src="day3 synthesis/sequential/dff const1/7 abc command.png">
<b>Fig.7 Mapping to standard cells using abc command</b>

<img src="day3 synthesis/sequential/dff const1/10 after abc.png">
<b>Fig.8 After mapping done using abc command</b>

<img src="day3 synthesis/sequential/dff const1/11 show op.png">
<b>Fig.9 Graphical view of the cells using show command</b>
